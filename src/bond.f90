! cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
    ...
    subroutine bond(r_atom,blngth,rorg,nrotat,iaxis,angle)

! This routine generates a bond (2 carbon atoms).
! cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
...
! Center of the bond is taken to be the origin and initially the
...
! Atom 1
    ...
    r_atom(1,1)=-0.5d0*blngth
    r_atom(2,1)=0.d0
    r_atom(3,1)=0.d0

! Atom 2

    r_atom(1,2)=0.5d0*blngth
    r_atom(2,2)=0.d0
    r_atom(3,2)=0.d0
